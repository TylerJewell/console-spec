...
export const Route = createFileRoute("/anomalies/all")({
  component: AllAnomaliesPage,
});
    ...
    <div className="space-y-4">
      {criticalCount != null && criticalCount > 0 && (
        <NoticeBanner severity="warning">
          {criticalCount} critical anomal{criticalCount === 1 ? "y" : "ies"} currently active across all systems.
        </NoticeBanner>
      )}
